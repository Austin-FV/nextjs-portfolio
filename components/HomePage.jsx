...
const HomePage = () => {
    ...
    return (
        <div id='home' className='h-screen w-full text-center pt-24'>
        <div className={darkMode ? "dark" : ""}>
            ...
            <main className='bg-transparent px-10 md:px-20 lg:px-40 dark:bg-gray-900'>



                <section className='min-h-screen'>

                    {/* NAV BAR (dark mode and resume buttons) */}
                    ...
                    <div className='text-5xl flex justify-center gap-16 py-3 text-gray-600'>
                        ...
                        <a href='#' onClick={() => setColorMode(colorMode === "light" ? "dark" : "light")}><AiFillMail /></a>
                    </div>
